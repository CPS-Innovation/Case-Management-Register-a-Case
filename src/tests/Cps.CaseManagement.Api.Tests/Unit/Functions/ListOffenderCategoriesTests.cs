...
public class ListOffenderCategoriesTests
{
    ...
    public ListOffenderCategoriesTests()
    {
        ...
        _function = new ListOffenderCategories(_mdsServiceMock.Object, _mdsArgFactoryMock.Object);
    }
    ...
    {
        // Arrange
        var expectedOffenderCategories = _fixture.Create<OffenderCategoryDto[]>();
        ...
        _mdsServiceMock.Verify(c => c.GetOffenderCategoriesAsync(baseArg), Times.Once);
    }
}
