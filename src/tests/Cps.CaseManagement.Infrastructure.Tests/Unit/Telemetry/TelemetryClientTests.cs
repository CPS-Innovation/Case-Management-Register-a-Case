...
public class TelemetryClientTest
{
    ...
    private readonly Infrastructure.Telemetry.TelemetryClient _telemetryClient;

    public TelemetryClientTest()
    {
        _mockAppInsightsTelemetryClient = new Mock<IAppInsightsTelemetryClient>();
        _telemetryClient = new Infrastructure.Telemetry.TelemetryClient(_mockAppInsightsTelemetryClient.Object);
    }
    ...
    {
        // Act
        var result = Infrastructure.Telemetry.TelemetryClient.ToLowerFirstChar("TestString");
